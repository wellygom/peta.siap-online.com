<form name="frm" id="frm" action="" method="post" >
    	...
    	<tr class="trEvn">
			...
			<td><div id="akreditasiReq"></div></td>
		</tr>
		<tr class ="trOdd">
			<td class ="colEvn"></td>
			<td><input type="button" id="okButton" style="color:#000000; font-family: Geneva, Arial, Helvetica, sans-serif; font-size:11px" value="Cari Data" onClick="validate(document.getElementById('selTwo'), document.getElementById('k_jenjang'), document.getElementById('k_status'), document.getElementById('selOne'),document.getElementById('akreditasi'));"></td>
			<td></td>
		</tr>
