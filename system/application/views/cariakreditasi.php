...
<!--script validation-->
<script src="<?=base_url();?>sknimg/js/validasi_akreditasi.js" type="text/javascript"></script>
<!--data kab&kota-->
<!--script data sekolah-->
...
<script type="text/javascript" src="<?=base_url();?>sknimg/js/cari.js"></script>
</head>
				                  		...
				                  		<div>
                    						...
                    						<table class="tbCap2" border="0" style="color:#797979; width:355px" cellspacing="0" cellpadding="0">
                      							<tbody>
                        							<!--form data sekolah-->
                        							<a name="form">
                        								<?php include("form_data_akreditasi.php");?>
                        							</a>
                        							<!--end-->
                      							</tbody>
                    						</table>
