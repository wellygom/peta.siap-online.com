...
function halaman(hal){
	...
	$(".tablesorter").html("");
	$(".pageOf").html(page);
	cari_sekolah("<?=$k_lokasi;?>","<?=$k_jenjang;?>","<?=$k_status;?>",hal,"8");
}
function next(hal){
	if (hal==2){
		hal=hal+1;
...
$(document).ready(function() {
	cari_sekolah("<?=$k_lokasi;?>","<?=$k_jenjang;?>","<?=$k_status;?>",page,"8");
	if(max==1){
		$(".page").html("1");
		$(".next").html("");
		$(".prev").html("");
                            ...
                            <div class="sdw-r"></div>
					        	<table cellpadding="0" cellspacing="0" border="0">
					            	<tr>
					                    ...
					                    <td class="desc">Data sebaran Sekolah yang terdatar di Indonesia <br /> berdasarkan Jenjang dan status</td>
										...
										<!-- <td><p align="right"><font size="2"><?php echo "Total Halaman : $maxHalaman";?><br><a href="#" onClick="halaman_prev(page-1);page=page-1;">Prev</a>&nbsp;&nbsp;<b class="page"></b>&nbsp;<a href="#" onClick="halaman_next(page+1);page=page+1">Next</a></font><span></p></td>
										-->
