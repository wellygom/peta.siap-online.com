...
/**
function mengubah data obyek kedalam bentuk array
	params object data
	return array
**/
function ToArray( $obyek )
{
     if( !is_object( $obyek ) && !is_array( $obyek ) )
      {
            return $obyek;
      }
      if( is_object( $obyek ) )
      {
            $obyek = get_object_vars( $obyek );
      }

       	return array_map( 'ToArray', $obyek );
}
